window.onload = function()
{
   ...
   /* var player1;
    ...
    function create() //create game objects needed to start
    {
    	    ...
    	    timeText = game.add.text(450, 75, 'ETime Left: ' + Math.floor(((15999 - (game.time.now - startTime)) / 1000) % 60), textTimeStyle);
